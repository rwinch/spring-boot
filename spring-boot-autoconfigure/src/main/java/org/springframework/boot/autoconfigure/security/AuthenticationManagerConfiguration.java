...
public class AuthenticationManagerConfiguration {
	...
	private static class BootDefaultingAuthenticationConfigurerAdapter extends
		...
		public void init(AuthenticationManagerBuilder auth) throws Exception {
			auth
				.apply(new DefaultingInMemoryUserDetailsManagerConfigurer(security));
		}
		 ...
		 * @author Rob Winch
		 */
		private static class DefaultingInMemoryUserDetailsManagerConfigurer extends InMemoryUserDetailsManagerConfigurer<AuthenticationManagerBuilder> {
			private final SecurityProperties security;
