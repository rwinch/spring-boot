...
/**
 * Tests for {@link ReloadProperties}.
 *
 * @author Phillip Webb
 */
public class ReloadPropertiesTests {

	@Test
	public void missingProperties() throws Exception {
		ReloadProperties properties = new ReloadProperties();
		assertThat(properties.isDebug(), equalTo(false));
	...
	public void loadProperties() throws Exception {
		ReloadProperties properties = new ReloadProperties(getClass().getPackage()
				.getName().replace(".", "/")
				+ "/reload.properties");
		assertThat(properties.isDebug(), equalTo(true));
