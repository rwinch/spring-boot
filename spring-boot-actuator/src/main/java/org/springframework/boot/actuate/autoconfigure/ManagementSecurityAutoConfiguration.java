...
import org.springframework.boot.autoconfigure.security.WebSecurityConfiguration;
...
public class ManagementSecurityAutoConfiguration {
	...
	private static class IgnoredPathsWebSecurityConfigurerAdapter implements
		...
		public void init(WebSecurity builder) throws Exception {
			...
			// add them back.
			List<String> ignored = WebSecurityConfiguration.getIgnored(this.security);
	...
	protected static class ManagementWebSecurityConfigurerAdapter extends
		...
		protected void configure(HttpSecurity http) throws Exception {
			...
			if (paths.length > 0 && this.management.getSecurity().isEnabled()) {
				...
				WebSecurityConfiguration.configureHeaders(http.headers(),
